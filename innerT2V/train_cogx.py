...
def main(args):
    ...
    transformer = CogVideoXTransformer3DModel.from_pretrained(
        ...
        max_text_seq_length=getattr(args, "max_text_seq_length", 226),
        low_cpu_mem_usage=False
    )
    ref_transformer = CogVideoXTransformer3DModel.from_pretrained(
    ...
    scheduler = CogVideoXDPMImprovedScheduler.from_pretrained(args.pretrained_model_name_or_path, subfolder="scheduler")
    ...
    ref_lora_path = os.path.join(args.ref_model_name_or_path, "lora")
    ...
    if accelerator.is_main_process:
        ...
        tracker_name = args.tracker_name or "cogvideox-dpo"
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(models_to_accumulate), timer("iteration"):
                ...
                latent = latent_dist.sample() * VAE_SCALING_FACTOR
                ...
                if model_config.patch_size_t is not None and model_input.shape[1] % model_config.patch_size_t > 0:
                    first_frame = model_input[:, : model_input.shape[1] % model_config.patch_size_t, ...]
                    model_input = torch.cat([first_frame, model_input], dim=1)
                ...
                image_rotary_emb = (
                    prepare_rotary_positional_embeddings(
                        ...
                        sample_height=model_config.sample_height,
                        sample_width=model_config.sample_width,
                    )
                ...
                ref_model_pred = scheduler.get_velocity(ref_model_output, noisy_model_input, timesteps)
                ...
                weights = 1 / (1 - alphas_cumprod[timesteps_half])
