...
# If no device detected (maybe in docker image building), try compiling for sm89 sm90
if device_count == 0:
    compute_capabilities.add("8.9") # for L20, L40S
    # compute_capabilities.add("9.0") # for H20
