...
import extensions.xfuser.envs as envs
...
class GroupCoordinator:
    ...
    def all_gather(
        ...
        # [NOTE] cannot movedim before separate_tensors as the .narrow assumes
        # that the gathered tensors are still stacked at the 0th dimension
        # if dim != 0:
        #     input_size[0] //= world_size
        #     output_tensor = output_tensor.reshape([world_size, ] + input_size)
        #     output_tensor = output_tensor.movedim(0, dim).contiguous()
    ...
    def all_gather_object(self, obj: Optional[Any] = None):
        """All gather objects into an object list.
        """
        ...
        torch.distributed.all_gather_object(obj_list, obj, group=self.cpu_group)
        return obj_list
