...
from extensions.xfuser.core.long_ctx_attention import xFuserLongContextAttention
    ...
    for step in range(comm.world_size):
        ...
        if not causal or step <= comm.rank:
            if flash_attn is None:
                ...
                compatible_kwargs = {}
                if 'softcap' in inspect.signature(_flash_attn_forward).parameters:
                    compatible_kwargs['softcap'] = 0.0
