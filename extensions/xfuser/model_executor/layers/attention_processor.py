...
from extensions.xfuser.core.cache_manager.cache_manager import get_cache_manager
from extensions.xfuser.core.distributed.runtime_state import get_runtime_state
from extensions.xfuser.model_executor.layers import xFuserLayerBaseWrapper
from extensions.xfuser.model_executor.layers import xFuserLayerWrappersRegister
from extensions.xfuser.logger import init_logger
from extensions.xfuser.envs import PACKAGES_CHECKER

if torch.__version__ >= "2.5.0":
    from extensions.xfuser.model_executor.layers.usp import USP
else:
    from extensions.xfuser.model_executor.layers.usp_legacy import USP
...
class xFuserAttnProcessor2_0(AttnProcessor2_0):
    def __init__(self):
        ...
        if HAS_LONG_CTX_ATTN and get_sequence_parallel_world_size() > 1:
            from extensions.xfuser.core.long_ctx_attention import (
