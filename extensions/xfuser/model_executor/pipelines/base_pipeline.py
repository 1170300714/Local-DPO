...
try:
    ...
    print("distvae is not installed, fallback DecoderAdapter to identical mapping")
    def DecoderAdapter(m, *args, **kwargs):
        return m
from extensions.xfuser.core.distributed.group_coordinator import GroupCoordinator
from extensions.xfuser.config.config import (
    EngineConfig,
    InputConfig,
)
from extensions.xfuser.core.distributed.parallel_state import get_tensor_model_parallel_world_size
from extensions.xfuser.logger import init_logger
...
from extensions.xfuser.core.fast_attention import (
    get_fast_attn_enable,
    initialize_fast_attn_state,
    fast_attention_compression,
)
from extensions.xfuser.model_executor.base_wrapper import xFuserBaseWrapper

from extensions.xfuser.envs import PACKAGES_CHECKER

PACKAGES_CHECKER.check_diffusers_version()

from extensions.xfuser.model_executor.schedulers import *
from extensions.xfuser.model_executor.models.transformers import *
from extensions.xfuser.model_executor.layers.attention_processor import *
from extensions.xfuser.config.config import ParallelConfig
try:
    import os
